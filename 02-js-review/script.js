...
const [primary,seconday]=book.genres;
console.log(primary,seconday);


// The rest operator 
const [frist,second, ...others]=book.genres;
...
// String literals
const string=`${title} is written by ${author} has ${book.hasMovieAdaptation ? "":"not"} movie adaptation`
string

// Ternary operator 
const ter = book.pages > 1000 ? "over thousand" : "less than thousand";
ter;
...
// filter method
const longbook = books.filter((book) => book.pages > 1000);
longbook;
...
const sorted = books.slice().sort((a, b) => b.pages - a.pages);
console.log(sorted);
